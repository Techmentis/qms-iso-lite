 ...
 */
	public function _prepare(&$Model, $resource) {
 ...
 */
	public function _source(&$Model, $resource) {
 ...
 * @return array|boolean Parsed results on success, false on error
 */
	public function _temporary(&$Model, $resource) {
		if (TransferValidation::fileUpload($resource)
 ...
 * @return array|boolean Parsed results on success, false on error
 */
	public function _destination(&$Model, $resource) {
