...
<p>
<?php echo __d('cake_dev', 'CakePHP is a rapid development framework for PHP which uses deleteallly known design patterns like Active Record, Association Data Mapping, Front Controller and MVC.'); ?>
</p>
<p>
