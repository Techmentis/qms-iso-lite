...
<div style=\"background:#f9f9f9 url(http://www.flinkiso.com/images/white_texture.png) ;margin:0px; float:left; padding:5px 20px; color:#333333; width:820px\">
        ...
        <table>
		    ...
		    <br />
                    ".$reportType." reports are successfully generated and stored in a safe location. You can view these reports by logging to FlinkISO™ application and then navigating to “Auto Reports” section.
		    <br />
		    <br />
		    This email is automatically generated from the FlinkISO™ cron jobs / schedule tasks.
		    <br />
                    <br/><br/>
                    Regards<br/>
                    <a href = \"https://www.flinkiso.com\">FlinkISO™</a>- Free Open Source QMS
                </td>
            </tr>
            </table>
        </div>
