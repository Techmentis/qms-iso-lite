...
<html>
    ...
    <body>
        ...
        <div style=\"background:#16AFDD;margin:0px; float:left; padding:5px 20px; border-bottom:1px dashed #FFFFFF; color:#fff; width:820px; text-shadow:0px 0px 1px #000000; line-height:19px\">
             <h2>Demo Expiration Reminder</h2>
        </div>
                ...
                <table>
                    <tr>
                        <td style='padding:10px'>
                            ...
                            By choosing flinkISO you have taken the first step towards standardizing your ISO certification related documentation.
                            <br /><br />
                            We like to remind you that, your demo login is going to expire on ".$view_vars.".<br /><br />

                            We request you to make full use of FlinkISO before your FlinkISO Demo expires. You would realize over a period of time that by regular use of flinkISO you have optimized the valuable time & effort spent by your resources on ISO certification related documentation.
                            <br /><br />
                            For any additional support, please feel to contact us at help@flinkiso.com <br /><br />
