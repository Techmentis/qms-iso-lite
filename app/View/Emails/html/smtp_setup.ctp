...
<div style=\"background:#f9f9f9 url(http://www.flinkiso.com/images/white_texture.png) ;margin:0px; float:left; padding:5px 20px; color:#333333; width:820px\">
        ...
        <table>
            <tr>
                ...
                <br /><br />
                Your SMTP setup for flinkiso is successfully done.
                <br /><br />
                Please make sure you read help available under Help section once you login to your flinkiso account.<br/><br/>
                For any additional support, please feel to contact us at <a href='mailto:help@flinkiso.com'>help@flinkiso.com</a>
                <br/><br/>
Warm Regards
<br/>
Team - FlinkISO.com
