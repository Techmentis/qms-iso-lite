    ...
    $().ready(function() {
        ...
        $('#ChangeAdditionDeletionRequestApproveForm').validate({
            rules: {
                ...
                "data[ChangeAdditionDeletionRequest][approved_by]": {
                    greaterThanZero: true,
                },
            }
        });
        ...
        $('#ChangeAdditionDeletionRequestApprovedBy').change(function() {
            if ($(this).val() != -1 && $(this).next().next('label').hasClass("error")) {
                $(this).next().next('label').remove();
            }
        });
...
<div id="changeAdditionDeletionRequests_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="changeAdditionDeletionRequests form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Change Addition Deletion Request'); ?>
		    ...
		    <?php } else {
		     ...
		     ?>
                ...
                <div class="col-md-6"><?php echo $this->Form->input('meeting_topic_id', array('label' => __('Select Meeting'),'options'=>$meetings,'default'=>$this->request->data['ChangeAdditionDeletionRequest']['meeting_id'])); ?></div>
