...
<div class="pull-right">
	    <div class="btn-group">
		<?php echo $this->Html->link('<span class="glyphicon glyphicon-chevron-left"></span>', array('controller'=>'histories','action'=>'graph_data_departments',date('Y-m-d',strtotime('-1 day',strtotime($newDate))),$this->request->params['pass'][1],$this->request->params['pass'][2]),array('class'=>'lk btn btn-sm btn-warning ','style'=>'height:30px;color:#fff','escape'=>false)); ?>
		<?php echo $this->Html->link($newDate , array('controller'=>'histories','action'=>'graph_data_departments',$newDate,$this->request->params['pass'][1],$this->request->params['pass'][2]),array('class'=>'lk btn btn-sm btn-default ','escape'=>false)); ?>
...
<div style="clear:both">
    <script >
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable(<?php echo $departmentData ?>);
	  ...
	  colors:['#5BC0DE','#f0ad4e'],
        ...
        var chart = new google.visualization.ComboChart(document.getElementById('department_chart_div'));
        chart.draw(data, options);
      }

</script>

<div id="department_chart_div" style="width: 100%; height: 400px;"></div>
</div>
<?php }else {  ?>
  <div class="">
