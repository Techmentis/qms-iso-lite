        ...
        <div class="employees form col-md-8 panel">
            ...
            <div class="row">
                <fieldset><legend><h5><?php echo __('Optional Details'); ?></h5></legend>
                    <div class="col-md-6">
                        <?php $qualifications = explode(",", $this->data['Employee']['qualification']); ?>
                        <?php echo $this->Form->input('qualification', array('name' => 'qualification[]', 'type' => 'select', 'options' => $educations, 'value' => $qualifications, 'multiple', 'label' => __('Qualification'))); ?></div>
