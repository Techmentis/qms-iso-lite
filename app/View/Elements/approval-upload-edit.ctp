<?php echo "<h4>&nbsp;&nbsp;" . __("Evidence Files") . "</h4>"; ?>
<table class="table table-striped table-hover table-bordered table-responsive ">
	...
	$fullPath = WWW_ROOT . DS. '/files/'.$this->Session->read('User.company_id').'/upload/'.$usersId . '/' . approvals . '/' . $apprecordId . '/'.$file['FileUpload']['file_details'].'.'.$file['FileUpload']['file_type'];
	$displayPath = '/files/'.$this->Session->read('User.company_id').'/upload/'.$usersId . '/' . approvals . '/' . $apprecordId . '/'. $file['FileUpload']['file_details'].'.'.$file['FileUpload']['file_type'];
