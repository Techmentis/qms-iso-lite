...
?>
        ...
        <?php 
            if($file['FileUpload']['file_status'] == 1){
                echo $this->Html->link('Edit',array('controller'=>'file_uploads','action'=>'edit',$file['FileUpload']['id'],$file['FileUpload']['system_table_id'],$this->request->params['pass'][0]),array('class'=>'badge btn-warning')); 
