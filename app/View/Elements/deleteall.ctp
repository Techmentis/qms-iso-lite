<div class="modal fade" id="deleteAll" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo $this->Form->create($this->name, array('action' => 'delete_all', 'role' => 'form', 'class' => 'form', 'style' => 'clear:both;overflow:auto')); ?>
            <?php echo $this->Form->hidden('recs_selected', array('id' => 'recs_selected_for_delete')); ?>
            <?php echo $this->Form->hidden('deleteAll.model_name', array('value' => Inflector::camelize(Inflector::singularize($this->request->params['controller'])))); ?>
