        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td class=" actions">
                        <?php echo $this->element('actions', array('created' => $task['Task']['created_by'], 'postVal' => $task['Task']['id'], 'softDelete' => $task['Task']['soft_delete'])); ?>
                    </td>
                    <td><?php echo h($task['Task']['name']); ?>&nbsp;</td>
                    <td>
                        <?php echo $this->Html->link($task['User']['name'], array('controller' => 'users', 'action' => 'view', $task['User']['id'])); ?>
                    </td>
                    <td><?php echo h($task['MasterListOfFormat']['title']); ?>&nbsp;</td>
                    <td>
