...
<script>
    ...
    $().ready(function() {
        ...
        $('#HousekeepingChecklistAddAjaxForm').validate({
            rules: {
...
<div id="housekeepingChecklists_ajax">
    ...
    <div class="nav">
        <div class="housekeepingChecklists form col-md-8">
            <h4><?php echo __('Add Housekeeping Checklist'); ?></h4>
            <?php echo $this->Form->create('HousekeepingChecklist', array('role' => 'form', 'class' => 'form', 'default' => false)); ?>
            ...
            ?>
            <?php echo $this->Form->submit(__('Submit'), array('div' => false, 'class' => 'btn btn-primary btn-success', 'update' => '#housekeepingChecklists_ajax', 'async' => 'false','id'=>'submit_id')); ?>
