<?php
App::uses('CustomerComplaintsController', 'Controller');

/**
 * CustomerComplaintsController Test Case
 *
 */
class CustomerComplaintsControllerTest extends ControllerTestCase {
