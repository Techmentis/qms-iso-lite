<?php
App::uses('FireExtinguisherTypesController', 'Controller');

/**
 * FireExtinguisherTypesController Test Case
 *
 */
class FireExtinguisherTypesControllerTest extends ControllerTestCase {
