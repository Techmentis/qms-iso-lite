<?php
App::uses('HousekeepingChecklistsController', 'Controller');

/**
 * HousekeepingChecklistsController Test Case
 *
 */
class HousekeepingChecklistsControllerTest extends ControllerTestCase {
