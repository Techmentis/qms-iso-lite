<?php
App::uses('PurchaseOrderDetailsController', 'Controller');

/**
 * PurchaseOrderDetailsController Test Case
 *
 */
class PurchaseOrderDetailsControllerTest extends ControllerTestCase {
