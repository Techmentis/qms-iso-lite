<?php
App::uses('TrainingScheduleDepartmentsController', 'Controller');

/**
 * TrainingScheduleDepartmentsController Test Case
 *
 */
class TrainingScheduleDepartmentsControllerTest extends ControllerTestCase {
