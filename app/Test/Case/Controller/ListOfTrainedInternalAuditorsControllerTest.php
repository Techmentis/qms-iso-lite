<?php
App::uses('ListOfTrainedInternalAuditorsController', 'Controller');

/**
 * ListOfTrainedInternalAuditorsController Test Case
 *
 */
class ListOfTrainedInternalAuditorsControllerTest extends ControllerTestCase {
