<?php
App::uses('TrainingScheduleBranchesController', 'Controller');

/**
 * TrainingScheduleBranchesController Test Case
 *
 */
class TrainingScheduleBranchesControllerTest extends ControllerTestCase {
