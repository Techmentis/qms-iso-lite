<?php
App::uses('MessageUserInboxesController', 'Controller');

/**
 * MessageUserInboxesController Test Case
 *
 */
class MessageUserInboxesControllerTest extends ControllerTestCase {
