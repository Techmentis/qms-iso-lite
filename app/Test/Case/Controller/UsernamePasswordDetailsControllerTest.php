<?php
App::uses('UsernamePasswordDetailsController', 'Controller');

/**
 * UsernamePasswordDetailsController Test Case
 *
 */
class UsernamePasswordDetailsControllerTest extends ControllerTestCase {
