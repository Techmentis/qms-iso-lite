<?php
App::uses('TrainingScheduleEmployeesController', 'Controller');

/**
 * TrainingScheduleEmployeesController Test Case
 *
 */
class TrainingScheduleEmployeesControllerTest extends ControllerTestCase {
