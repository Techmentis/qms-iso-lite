<?php
App::uses('HousekeepingResponsibilitiesController', 'Controller');

/**
 * HousekeepingResponsibilitiesController Test Case
 *
 */
class HousekeepingResponsibilitiesControllerTest extends ControllerTestCase {
