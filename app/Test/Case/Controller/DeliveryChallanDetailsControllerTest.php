<?php
App::uses('DeliveryChallanDetailsController', 'Controller');

/**
 * DeliveryChallanDetailsController Test Case
 *
 */
class DeliveryChallanDetailsControllerTest extends ControllerTestCase {
