<?php
App::uses('SummeryOfSupplierEvaluationsController', 'Controller');

/**
 * SummeryOfSupplierEvaluationsController Test Case
 *
 */
class SummeryOfSupplierEvaluationsControllerTest extends ControllerTestCase {
