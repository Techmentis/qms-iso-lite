<?php
App::uses('InternalAuditPlanBranchesController', 'Controller');

/**
 * InternalAuditPlanBranchesController Test Case
 *
 */
class InternalAuditPlanBranchesControllerTest extends ControllerTestCase {
