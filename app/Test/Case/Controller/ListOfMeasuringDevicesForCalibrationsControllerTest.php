<?php
App::uses('ListOfMeasuringDevicesForCalibrationsController', 'Controller');

/**
 * ListOfMeasuringDevicesForCalibrationsController Test Case
 *
 */
class ListOfMeasuringDevicesForCalibrationsControllerTest extends ControllerTestCase {
