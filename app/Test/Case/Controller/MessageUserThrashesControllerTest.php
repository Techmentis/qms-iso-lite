<?php
App::uses('MessageUserThrashesController', 'Controller');

/**
 * MessageUserThrashesController Test Case
 *
 */
class MessageUserThrashesControllerTest extends ControllerTestCase {
