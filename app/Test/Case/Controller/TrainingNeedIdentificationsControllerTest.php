<?php
App::uses('TrainingNeedIdentificationsController', 'Controller');

/**
 * TrainingNeedIdentificationsController Test Case
 *
 */
class TrainingNeedIdentificationsControllerTest extends ControllerTestCase {
