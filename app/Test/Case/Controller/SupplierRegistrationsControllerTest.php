<?php
App::uses('SupplierRegistrationsController', 'Controller');

/**
 * SupplierRegistrationsController Test Case
 *
 */
class SupplierRegistrationsControllerTest extends ControllerTestCase {
