<?php
App::uses('SupplierEvaluationReevaluationsController', 'Controller');

/**
 * SupplierEvaluationReevaluationsController Test Case
 *
 */
class SupplierEvaluationReevaluationsControllerTest extends ControllerTestCase {
