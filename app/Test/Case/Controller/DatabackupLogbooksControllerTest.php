<?php
App::uses('DatabackupLogbooksController', 'Controller');

/**
 * DatabackupLogbooksController Test Case
 *
 */
class DatabackupLogbooksControllerTest extends ControllerTestCase {
