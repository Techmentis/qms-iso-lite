<?php
App::uses('DailyBackupDetailsController', 'Controller');

/**
 * DailyBackupDetailsController Test Case
 *
 */
class DailyBackupDetailsControllerTest extends ControllerTestCase {
