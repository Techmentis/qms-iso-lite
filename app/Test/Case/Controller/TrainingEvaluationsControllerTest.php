<?php
App::uses('TrainingEvaluationsController', 'Controller');

/**
 * TrainingEvaluationsController Test Case
 *
 */
class TrainingEvaluationsControllerTest extends ControllerTestCase {
