<?php
App::uses('CorrectivePreventiveActionsController', 'Controller');

/**
 * CorrectivePreventiveActionsController Test Case
 *
 */
class CorrectivePreventiveActionsControllerTest extends ControllerTestCase {
