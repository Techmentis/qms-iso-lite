<?php
App::uses('ListOfAcceptableSuppliersController', 'Controller');

/**
 * ListOfAcceptableSuppliersController Test Case
 *
 */
class ListOfAcceptableSuppliersControllerTest extends ControllerTestCase {
