<?php
App::uses('ListOfComputerListOfSoftwaresController', 'Controller');

/**
 * ListOfComputerListOfSoftwaresController Test Case
 *
 */
class ListOfComputerListOfSoftwaresControllerTest extends ControllerTestCase {
