<?php
App::uses('EmployeeInductionTrainingsController', 'Controller');

/**
 * EmployeeInductionTrainingsController Test Case
 *
 */
class EmployeeInductionTrainingsControllerTest extends ControllerTestCase {
