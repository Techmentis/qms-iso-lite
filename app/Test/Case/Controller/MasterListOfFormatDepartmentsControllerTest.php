<?php
App::uses('MasterListOfFormatDepartmentsController', 'Controller');

/**
 * MasterListOfFormatDepartmentsController Test Case
 *
 */
class MasterListOfFormatDepartmentsControllerTest extends ControllerTestCase {
