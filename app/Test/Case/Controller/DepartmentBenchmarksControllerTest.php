<?php
App::uses('DepartmentBenchmarksController', 'Controller');

/**
 * DepartmentBenchmarksController Test Case
 *
 */
class DepartmentBenchmarksControllerTest extends ControllerTestCase {
