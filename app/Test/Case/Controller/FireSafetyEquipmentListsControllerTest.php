<?php
App::uses('FireSafetyEquipmentListsController', 'Controller');

/**
 * FireSafetyEquipmentListsController Test Case
 *
 */
class FireSafetyEquipmentListsControllerTest extends ControllerTestCase {
