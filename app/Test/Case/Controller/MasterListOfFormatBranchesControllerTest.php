<?php
App::uses('MasterListOfFormatBranchesController', 'Controller');

/**
 * MasterListOfFormatBranchesController Test Case
 *
 */
class MasterListOfFormatBranchesControllerTest extends ControllerTestCase {
