<?php
App::uses('EmployeeDesignationsController', 'Controller');

/**
 * EmployeeDesignationsController Test Case
 *
 */
class EmployeeDesignationsControllerTest extends ControllerTestCase {
