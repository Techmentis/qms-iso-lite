<?php
App::uses('InternalAuditDetailsController', 'Controller');

/**
 * InternalAuditDetailsController Test Case
 *
 */
class InternalAuditDetailsControllerTest extends ControllerTestCase {
