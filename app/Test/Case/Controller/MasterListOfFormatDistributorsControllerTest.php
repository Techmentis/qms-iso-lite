<?php
App::uses('MasterListOfFormatDistributorsController', 'Controller');

/**
 * MasterListOfFormatDistributorsController Test Case
 *
 */
class MasterListOfFormatDistributorsControllerTest extends ControllerTestCase {
