<?php
App::uses('InternetUsageDetailsController', 'Controller');

/**
 * InternetUsageDetailsController Test Case
 *
 */
class InternetUsageDetailsControllerTest extends ControllerTestCase {
