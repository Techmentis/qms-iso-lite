<?php
App::uses('MeetingDepartmentsController', 'Controller');

/**
 * MeetingDepartmentsController Test Case
 *
 */
class MeetingDepartmentsControllerTest extends ControllerTestCase {
