<?php
App::uses('ChangeAdditionDeletionRequestsController', 'Controller');

/**
 * ChangeAdditionDeletionRequestsController Test Case
 *
 */
class ChangeAdditionDeletionRequestsControllerTest extends ControllerTestCase {
