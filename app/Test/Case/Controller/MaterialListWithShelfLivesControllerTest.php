<?php
App::uses('MaterialListWithShelfLivesController', 'Controller');

/**
 * MaterialListWithShelfLivesController Test Case
 *
 */
class MaterialListWithShelfLivesControllerTest extends ControllerTestCase {
