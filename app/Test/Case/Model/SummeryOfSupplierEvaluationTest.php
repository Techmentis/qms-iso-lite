<?php
App::uses('SummeryOfSupplierEvaluation', 'Model');

/**
 * SummeryOfSupplierEvaluation Test Case
 *
 */
class SummeryOfSupplierEvaluationTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SummeryOfSupplierEvaluation = ClassRegistry::init('SummeryOfSupplierEvaluation');
	}
 ...
 */
	public function tearDown() {
		unset($this->SummeryOfSupplierEvaluation);
