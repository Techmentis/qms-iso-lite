<?php
App::uses('TrainerType', 'Model');

/**
 * TrainerType Test Case
 *
 */
class TrainerTypeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TrainerType = ClassRegistry::init('TrainerType');
	}
