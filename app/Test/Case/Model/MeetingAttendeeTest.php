<?php
App::uses('MeetingAttendee', 'Model');

/**
 * MeetingAttendee Test Case
 *
 */
class MeetingAttendeeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MeetingAttendee = ClassRegistry::init('MeetingAttendee');
	}
