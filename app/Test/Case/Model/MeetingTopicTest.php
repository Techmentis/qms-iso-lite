<?php
App::uses('MeetingTopic', 'Model');

/**
 * MeetingTopic Test Case
 *
 */
class MeetingTopicTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MeetingTopic = ClassRegistry::init('MeetingTopic');
	}
