<?php
App::uses('SuggesionForm', 'Model');

/**
 * SuggesionForm Test Case
 *
 */
class SuggesionFormTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SuggesionForm = ClassRegistry::init('SuggesionForm');
	}
