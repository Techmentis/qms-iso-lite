<?php
App::uses('TrainingEvaluation', 'Model');

/**
 * TrainingEvaluation Test Case
 *
 */
class TrainingEvaluationTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TrainingEvaluation = ClassRegistry::init('TrainingEvaluation');
	}
