<?php
App::uses('FireSafetyEquipmentList', 'Model');

/**
 * FireSafetyEquipmentList Test Case
 *
 */
class FireSafetyEquipmentListTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->FireSafetyEquipmentList = ClassRegistry::init('FireSafetyEquipmentList');
	}
 ...
 */
	public function tearDown() {
		unset($this->FireSafetyEquipmentList);
