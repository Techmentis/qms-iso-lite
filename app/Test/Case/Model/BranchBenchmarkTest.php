<?php
App::uses('BranchBenchmark', 'Model');

/**
 * BranchBenchmark Test Case
 *
 */
class BranchBenchmarkTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->BranchBenchmark = ClassRegistry::init('BranchBenchmark');
	}
