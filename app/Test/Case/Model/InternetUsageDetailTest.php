<?php
App::uses('InternetUsageDetail', 'Model');

/**
 * InternetUsageDetail Test Case
 *
 */
class InternetUsageDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->InternetUsageDetail = ClassRegistry::init('InternetUsageDetail');
	}
 ...
 */
	public function tearDown() {
		unset($this->InternetUsageDetail);
