<?php
App::uses('OrderDetailsForm', 'Model');

/**
 * OrderDetailsForm Test Case
 *
 */
class OrderDetailsFormTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderDetailsForm = ClassRegistry::init('OrderDetailsForm');
	}
