<?php
App::uses('DataBackUp', 'Model');

/**
 * DataBackUp Test Case
 *
 */
class DataBackUpTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->DataBackUp = ClassRegistry::init('DataBackUp');
	}
