<?php
App::uses('ListOfSoftware', 'Model');

/**
 * ListOfSoftware Test Case
 *
 */
class ListOfSoftwareTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ListOfSoftware = ClassRegistry::init('ListOfSoftware');
	}
