<?php
App::uses('CompanyBenchmark', 'Model');

/**
 * CompanyBenchmark Test Case
 *
 */
class CompanyBenchmarkTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CompanyBenchmark = ClassRegistry::init('CompanyBenchmark');
	}
