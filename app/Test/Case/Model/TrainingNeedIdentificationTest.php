<?php
App::uses('TrainingNeedIdentification', 'Model');

/**
 * TrainingNeedIdentification Test Case
 *
 */
class TrainingNeedIdentificationTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TrainingNeedIdentification = ClassRegistry::init('TrainingNeedIdentification');
	}
 ...
 */
	public function tearDown() {
		unset($this->TrainingNeedIdentification);
