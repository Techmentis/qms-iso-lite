<?php
App::uses('EmployeeInductionTraining', 'Model');

/**
 * EmployeeInductionTraining Test Case
 *
 */
class EmployeeInductionTrainingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EmployeeInductionTraining = ClassRegistry::init('EmployeeInductionTraining');
	}
 ...
 */
	public function tearDown() {
		unset($this->EmployeeInductionTraining);
