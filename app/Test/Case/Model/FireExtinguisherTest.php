<?php
App::uses('FireExtinguisher', 'Model');

/**
 * FireExtinguisher Test Case
 *
 */
class FireExtinguisherTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->FireExtinguisher = ClassRegistry::init('FireExtinguisher');
	}
