<?php
App::uses('InternalAuditPlanBranch', 'Model');

/**
 * InternalAuditPlanBranch Test Case
 *
 */
class InternalAuditPlanBranchTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->InternalAuditPlanBranch = ClassRegistry::init('InternalAuditPlanBranch');
	}
 ...
 */
	public function tearDown() {
		unset($this->InternalAuditPlanBranch);
