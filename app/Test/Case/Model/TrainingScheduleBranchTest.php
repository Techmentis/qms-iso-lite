<?php
App::uses('TrainingScheduleBranch', 'Model');

/**
 * TrainingScheduleBranch Test Case
 *
 */
class TrainingScheduleBranchTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TrainingScheduleBranch = ClassRegistry::init('TrainingScheduleBranch');
	}
 ...
 */
	public function tearDown() {
		unset($this->TrainingScheduleBranch);
