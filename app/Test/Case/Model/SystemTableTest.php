<?php
App::uses('SystemTable', 'Model');

/**
 * SystemTable Test Case
 *
 */
class SystemTableTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SystemTable = ClassRegistry::init('SystemTable');
	}
