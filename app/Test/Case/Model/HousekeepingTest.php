<?php
App::uses('Housekeeping', 'Model');

/**
 * Housekeeping Test Case
 *
 */
class HousekeepingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Housekeeping = ClassRegistry::init('Housekeeping');
	}
