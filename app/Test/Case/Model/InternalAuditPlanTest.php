<?php
App::uses('InternalAuditPlan', 'Model');

/**
 * InternalAuditPlan Test Case
 *
 */
class InternalAuditPlanTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->InternalAuditPlan = ClassRegistry::init('InternalAuditPlan');
	}
