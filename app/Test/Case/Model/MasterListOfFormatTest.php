<?php
App::uses('MasterListOfFormat', 'Model');

/**
 * MasterListOfFormat Test Case
 *
 */
class MasterListOfFormatTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MasterListOfFormat = ClassRegistry::init('MasterListOfFormat');
	}
