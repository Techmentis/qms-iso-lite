<?php
App::uses('MeetingDepartment', 'Model');

/**
 * MeetingDepartment Test Case
 *
 */
class MeetingDepartmentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MeetingDepartment = ClassRegistry::init('MeetingDepartment');
	}
