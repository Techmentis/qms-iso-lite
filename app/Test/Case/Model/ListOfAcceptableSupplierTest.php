<?php
App::uses('ListOfAcceptableSupplier', 'Model');

/**
 * ListOfAcceptableSupplier Test Case
 *
 */
class ListOfAcceptableSupplierTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ListOfAcceptableSupplier = ClassRegistry::init('ListOfAcceptableSupplier');
	}
 ...
 */
	public function tearDown() {
		unset($this->ListOfAcceptableSupplier);
