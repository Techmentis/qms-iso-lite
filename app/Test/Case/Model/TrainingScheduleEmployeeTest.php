<?php
App::uses('TrainingScheduleEmployee', 'Model');

/**
 * TrainingScheduleEmployee Test Case
 *
 */
class TrainingScheduleEmployeeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TrainingScheduleEmployee = ClassRegistry::init('TrainingScheduleEmployee');
	}
 ...
 */
	public function tearDown() {
		unset($this->TrainingScheduleEmployee);
