<?php
App::uses('SupplierEvaluationReevaluation', 'Model');

/**
 * SupplierEvaluationReevaluation Test Case
 *
 */
class SupplierEvaluationReevaluationTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SupplierEvaluationReevaluation = ClassRegistry::init('SupplierEvaluationReevaluation');
	}
 ...
 */
	public function tearDown() {
		unset($this->SupplierEvaluationReevaluation);
