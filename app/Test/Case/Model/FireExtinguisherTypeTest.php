<?php
App::uses('FireExtinguisherType', 'Model');

/**
 * FireExtinguisherType Test Case
 *
 */
class FireExtinguisherTypeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->FireExtinguisherType = ClassRegistry::init('FireExtinguisherType');
	}
 ...
 */
	public function tearDown() {
		unset($this->FireExtinguisherType);
