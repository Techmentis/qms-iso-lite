<?php
App::uses('EmployeeTraining', 'Model');

/**
 * EmployeeTraining Test Case
 *
 */
class EmployeeTrainingTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EmployeeTraining = ClassRegistry::init('EmployeeTraining');
	}
