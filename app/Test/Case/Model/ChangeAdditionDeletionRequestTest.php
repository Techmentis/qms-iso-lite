<?php
App::uses('ChangeAdditionDeletionRequest', 'Model');

/**
 * ChangeAdditionDeletionRequest Test Case
 *
 */
class ChangeAdditionDeletionRequestTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ChangeAdditionDeletionRequest = ClassRegistry::init('ChangeAdditionDeletionRequest');
	}
 ...
 */
	public function tearDown() {
		unset($this->ChangeAdditionDeletionRequest);
