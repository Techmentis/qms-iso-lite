<?php
App::uses('MasterListOfFormatDistributor', 'Model');

/**
 * MasterListOfFormatDistributor Test Case
 *
 */
class MasterListOfFormatDistributorTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MasterListOfFormatDistributor = ClassRegistry::init('MasterListOfFormatDistributor');
	}
 ...
 */
	public function tearDown() {
		unset($this->MasterListOfFormatDistributor);
