<?php
App::uses('DeliveryChallanDetail', 'Model');

/**
 * DeliveryChallanDetail Test Case
 *
 */
class DeliveryChallanDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->DeliveryChallanDetail = ClassRegistry::init('DeliveryChallanDetail');
	}
 ...
 */
	public function tearDown() {
		unset($this->DeliveryChallanDetail);
