<?php
App::uses('InternalAuditPlanDepartment', 'Model');

/**
 * InternalAuditPlanDepartment Test Case
 *
 */
class InternalAuditPlanDepartmentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->InternalAuditPlanDepartment = ClassRegistry::init('InternalAuditPlanDepartment');
	}
 ...
 */
	public function tearDown() {
		unset($this->InternalAuditPlanDepartment);
