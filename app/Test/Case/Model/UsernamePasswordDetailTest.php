<?php
App::uses('UsernamePasswordDetail', 'Model');

/**
 * UsernamePasswordDetail Test Case
 *
 */
class UsernamePasswordDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->UsernamePasswordDetail = ClassRegistry::init('UsernamePasswordDetail');
	}
 ...
 */
	public function tearDown() {
		unset($this->UsernamePasswordDetail);
