<?php
App::uses('MeetingEmployee', 'Model');

/**
 * MeetingEmployee Test Case
 *
 */
class MeetingEmployeeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MeetingEmployee = ClassRegistry::init('MeetingEmployee');
	}
