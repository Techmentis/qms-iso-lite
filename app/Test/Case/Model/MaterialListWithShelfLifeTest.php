<?php
App::uses('MaterialListWithShelfLife', 'Model');

/**
 * MaterialListWithShelfLife Test Case
 *
 */
class MaterialListWithShelfLifeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MaterialListWithShelfLife = ClassRegistry::init('MaterialListWithShelfLife');
	}
 ...
 */
	public function tearDown() {
		unset($this->MaterialListWithShelfLife);
