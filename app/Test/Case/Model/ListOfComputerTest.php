<?php
App::uses('ListOfComputer', 'Model');

/**
 * ListOfComputer Test Case
 *
 */
class ListOfComputerTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ListOfComputer = ClassRegistry::init('ListOfComputer');
	}
