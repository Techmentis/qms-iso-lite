<?php
App::uses('MeetingBranch', 'Model');

/**
 * MeetingBranch Test Case
 *
 */
class MeetingBranchTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MeetingBranch = ClassRegistry::init('MeetingBranch');
	}
