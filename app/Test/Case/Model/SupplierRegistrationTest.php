<?php
App::uses('SupplierRegistration', 'Model');

/**
 * SupplierRegistration Test Case
 *
 */
class SupplierRegistrationTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SupplierRegistration = ClassRegistry::init('SupplierRegistration');
	}
 ...
 */
	public function tearDown() {
		unset($this->SupplierRegistration);
