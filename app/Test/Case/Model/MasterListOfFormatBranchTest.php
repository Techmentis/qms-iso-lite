<?php
App::uses('MasterListOfFormatBranch', 'Model');

/**
 * MasterListOfFormatBranch Test Case
 *
 */
class MasterListOfFormatBranchTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MasterListOfFormatBranch = ClassRegistry::init('MasterListOfFormatBranch');
	}
 ...
 */
	public function tearDown() {
		unset($this->MasterListOfFormatBranch);
