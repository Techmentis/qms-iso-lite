<?php
App::uses('CustomerComplaint', 'Model');

/**
 * CustomerComplaint Test Case
 *
 */
class CustomerComplaintTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CustomerComplaint = ClassRegistry::init('CustomerComplaint');
	}
