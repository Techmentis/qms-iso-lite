<?php
App::uses('DailyBackupDetail', 'Model');

/**
 * DailyBackupDetail Test Case
 *
 */
class DailyBackupDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->DailyBackupDetail = ClassRegistry::init('DailyBackupDetail');
	}
