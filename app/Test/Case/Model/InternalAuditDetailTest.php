<?php
App::uses('InternalAuditDetail', 'Model');

/**
 * InternalAuditDetail Test Case
 *
 */
class InternalAuditDetailTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->InternalAuditDetail = ClassRegistry::init('InternalAuditDetail');
	}
 ...
 */
	public function tearDown() {
		unset($this->InternalAuditDetail);
