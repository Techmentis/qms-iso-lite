<?php
App::uses('MasterListOfFormatDepartment', 'Model');

/**
 * MasterListOfFormatDepartment Test Case
 *
 */
class MasterListOfFormatDepartmentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MasterListOfFormatDepartment = ClassRegistry::init('MasterListOfFormatDepartment');
	}
 ...
 */
	public function tearDown() {
		unset($this->MasterListOfFormatDepartment);
