<?php
App::uses('EmployeeDesignation', 'Model');

/**
 * EmployeeDesignation Test Case
 *
 */
class EmployeeDesignationTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->EmployeeDesignation = ClassRegistry::init('EmployeeDesignation');
	}
 ...
 */
	public function tearDown() {
		unset($this->EmployeeDesignation);
