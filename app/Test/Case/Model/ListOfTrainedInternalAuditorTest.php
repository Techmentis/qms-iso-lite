<?php
App::uses('ListOfTrainedInternalAuditor', 'Model');

/**
 * ListOfTrainedInternalAuditor Test Case
 *
 */
class ListOfTrainedInternalAuditorTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ListOfTrainedInternalAuditor = ClassRegistry::init('ListOfTrainedInternalAuditor');
	}
 ...
 */
	public function tearDown() {
		unset($this->ListOfTrainedInternalAuditor);
