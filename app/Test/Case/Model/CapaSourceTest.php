<?php
App::uses('CapaSource', 'Model');

/**
 * CapaSource Test Case
 *
 */
class CapaSourceTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CapaSource = ClassRegistry::init('CapaSource');
	}
