<?php
App::uses('CourierRegister', 'Model');

/**
 * CourierRegister Test Case
 *
 */
class CourierRegisterTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CourierRegister = ClassRegistry::init('CourierRegister');
	}
