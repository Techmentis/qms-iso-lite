<?php
App::uses('DepartmentBenchmark', 'Model');

/**
 * DepartmentBenchmark Test Case
 *
 */
class DepartmentBenchmarkTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->DepartmentBenchmark = ClassRegistry::init('DepartmentBenchmark');
	}
 ...
 */
	public function tearDown() {
		unset($this->DepartmentBenchmark);
