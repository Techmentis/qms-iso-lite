<?php
App::uses('CapaCategory', 'Model');

/**
 * CapaCategory Test Case
 *
 */
class CapaCategoryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CapaCategory = ClassRegistry::init('CapaCategory');
	}
