<?php
App::uses('DocumentAmendmentRecordSheet', 'Model');

/**
 * DocumentAmendmentRecordSheet Test Case
 *
 */
class DocumentAmendmentRecordSheetTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->DocumentAmendmentRecordSheet = ClassRegistry::init('DocumentAmendmentRecordSheet');
	}
 ...
 */
	public function tearDown() {
		unset($this->DocumentAmendmentRecordSheet);
