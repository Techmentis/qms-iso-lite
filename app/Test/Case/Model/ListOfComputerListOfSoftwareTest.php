<?php
App::uses('ListOfComputerListOfSoftware', 'Model');

/**
 * ListOfComputerListOfSoftware Test Case
 *
 */
class ListOfComputerListOfSoftwareTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->ListOfComputerListOfSoftware = ClassRegistry::init('ListOfComputerListOfSoftware');
	}
 ...
 */
	public function tearDown() {
		unset($this->ListOfComputerListOfSoftware);
