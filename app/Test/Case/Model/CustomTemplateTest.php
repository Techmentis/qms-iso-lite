<?php
App::uses('CustomTemplate', 'Model');

/**
 * CustomTemplate Test Case
 *
 */
class CustomTemplateTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CustomTemplate = ClassRegistry::init('CustomTemplate');
	}
