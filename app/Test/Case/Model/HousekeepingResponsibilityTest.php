<?php
App::uses('HousekeepingResponsibility', 'Model');

/**
 * HousekeepingResponsibility Test Case
 *
 */
class HousekeepingResponsibilityTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HousekeepingResponsibility = ClassRegistry::init('HousekeepingResponsibility');
	}
 ...
 */
	public function tearDown() {
		unset($this->HousekeepingResponsibility);
