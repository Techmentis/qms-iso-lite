<?php
App::uses('MessageUserThrash', 'Model');

/**
 * MessageUserThrash Test Case
 *
 */
class MessageUserThrashTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MessageUserThrash = ClassRegistry::init('MessageUserThrash');
	}
