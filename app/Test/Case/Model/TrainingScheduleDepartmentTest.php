<?php
App::uses('TrainingScheduleDepartment', 'Model');

/**
 * TrainingScheduleDepartment Test Case
 *
 */
class TrainingScheduleDepartmentTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TrainingScheduleDepartment = ClassRegistry::init('TrainingScheduleDepartment');
	}
 ...
 */
	public function tearDown() {
		unset($this->TrainingScheduleDepartment);
