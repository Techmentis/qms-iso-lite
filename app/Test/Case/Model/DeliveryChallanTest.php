<?php
App::uses('DeliveryChallan', 'Model');

/**
 * DeliveryChallan Test Case
 *
 */
class DeliveryChallanTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->DeliveryChallan = ClassRegistry::init('DeliveryChallan');
	}
