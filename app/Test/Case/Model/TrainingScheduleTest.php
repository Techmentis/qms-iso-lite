<?php
App::uses('TrainingSchedule', 'Model');

/**
 * TrainingSchedule Test Case
 *
 */
class TrainingScheduleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TrainingSchedule = ClassRegistry::init('TrainingSchedule');
	}
