<?php
App::uses('HousekeepingChecklist', 'Model');

/**
 * HousekeepingChecklist Test Case
 *
 */
class HousekeepingChecklistTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HousekeepingChecklist = ClassRegistry::init('HousekeepingChecklist');
	}
 ...
 */
	public function tearDown() {
		unset($this->HousekeepingChecklist);
