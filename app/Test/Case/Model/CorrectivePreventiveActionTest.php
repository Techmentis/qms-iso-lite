<?php
App::uses('CorrectivePreventiveAction', 'Model');

/**
 * CorrectivePreventiveAction Test Case
 *
 */
class CorrectivePreventiveActionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->CorrectivePreventiveAction = ClassRegistry::init('CorrectivePreventiveAction');
	}
 ...
 */
	public function tearDown() {
		unset($this->CorrectivePreventiveAction);
