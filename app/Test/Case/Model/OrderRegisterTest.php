<?php
App::uses('OrderRegister', 'Model');

/**
 * OrderRegister Test Case
 *
 */
class OrderRegisterTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->OrderRegister = ClassRegistry::init('OrderRegister');
	}
