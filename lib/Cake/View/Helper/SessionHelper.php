	...
	public function flash($key = 'flash', $attrs = array()) {
		...
		if (CakeSession::check('Message.' . $key)) {
			...
			if ($flash['element'] === 'default') {
				...
				$out = '<div id="' . $key . 'Message " class="alert alert-success  fade in ' . $class . '">' . $message . '<button aria-hidden="true" data-dismiss="alert" class="close" type="button">x</button></div>';
