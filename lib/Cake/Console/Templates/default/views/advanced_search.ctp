		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					...
					<?php printf("<?php echo \$this->Html->link(__('Export'), '#export',array('class'=>'label btn-warning','data-toggle'=>'modal','onClick'=>'getVals()')); ?>\n");?>
...
<?php endforeach; ?>
				...
				<?php
					...
					echo "\t\t\t\t<li><?php echo \$this->Html->link(__('View / Upload Evidance'), array('action' => 'view', \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?></li>\n";
...
<?php
	...
	echo "<?php echo \$this->Form->create('".$pluralVar."',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>\n";
	echo "<?php echo \$this->Form->hidden('rec_selected',array('id'=>'recs_selected'));?>\n";
	echo "<?php echo \$this->Form->submit('Export selcted records in pdf format',array('div'=>false,'class'=>'btn btn-link'));?>\n";
